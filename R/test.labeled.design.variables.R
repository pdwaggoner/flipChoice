#' A list containing labeled variables corresponding to the columns in a design
#' file. This is used to test the design.variables argument in FitChoiceModel.
#'
#' @docType data
#' @keywords datasets
#' @name test.labeled.design.variables
#' @usage data(test.labeled.design.variables)
